       ...
       -- bossData = bossData .. "</span></div>"
        ...
        for idx, val in ipairs(MRT_RaidLog[raidID]["Loot"]) do
            if (val["BossNumber"] == bossID and val["Looter"] ~= "_deleted_") then
                ...
                --bossData = bossData .. date(MRT_Options["Export_DateTimeFormat"], MRT_RaidLog[raidID]["StartTime"]) .. ","
                bossData = bossData .. "-,"
                bossData = bossData .. date("%Y-%m-%d", MRT_RaidLog[raidID]["StartTime"]) .. ","
                bossData = bossData .. val["ItemId"] .. ","
                bossData = bossData .. val["ItemName"] .. ","
